...
const Footer = () => {
  return (
     <div className='bg-[#F69FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div>
                    <p className='fond-playfair text-lg text-gray-800'>COMPANY</p>
                ...
                <div>
                    <p className='fond-playfairtext-lg text-gray-800'>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                ...
                <div className='max-w-80'>
                    <p className='fond-playfair text-lg text-gray-800'>STAY UPDATED</p>
